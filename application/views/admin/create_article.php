...
<html>
<head>
    <title>Create Article - RustHub Admin</title>
...
<div class="container mt-5">
    <h2><span class="rust-logo">&gt;_</span> Create New Article</h2>
    <div class="card p-4 mt-3">
        <?= validation_errors('<div class="alert alert-danger">', '</div>'); ?>
        <form action="<?= base_url('admin/create') ?>" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label class="form-label">Article Title</label>
                <input type="text" name="title" class="form-control" placeholder="e.g., Getting Started with Rust">
            </div>
            <div class="mb-3">
                <label class="form-label">Featured Image</label>
                <input type="file" name="image" class="form-control">
                <small style="color: #8b949e;">Accepts: JPG, PNG, GIF (Max 2MB)</small>
            </div>
            <div class="mb-3">
                ...
                <textarea name="content" class="form-control" rows="15" placeholder="## Your Article Title\n\nWrite your content here...\n\n```rust\nfn main() {\n    println!(\"Hello, RustHub!\");\n}\n```"></textarea>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-rust">Publish Article</button>
